      ...
      <div className="w-full container mx-auto my-16">
          <div className="w-full flex items-center justify-between">
            ...
            <div className="flex w-1/2 justify-end content-center">
              <a className="inline-block text-blue-300 no-underline hover:text-pink-500 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4 transform hover:scale-125 duration-300 ease-in-out" href="https://github.com/Azure-Samples/java-ai">
